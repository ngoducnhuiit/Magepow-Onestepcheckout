...
define([
    ...
    return Component.extend({
        ...
        triggerLogin: function () {
            if ($('.onestepcheckout-authentication-wrapper a.action-auth-toggle').hasClass('onestepcheckout-authentication-toggle')) {
                $('.onestepcheckout-authentication-toggle').trigger('click');
            } else {
