<?php
namespace Magepow\OnestepCheckout\Block\Adminhtml\System\Config\Form\Field;
...
class Version extends Field
{
    ...
    {
        return '<tr id="row_' . $element->getHtmlId() . '" class="row_magepow_module_version">' . $html . '</tr>';
    }
}
