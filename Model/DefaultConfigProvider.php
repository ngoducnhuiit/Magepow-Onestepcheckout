...
class DefaultConfigProvider implements ConfigProviderInterface
{
    ...
    private function getMageConfig()
    {
        return [
            ...
            'newsletterDefault'       => $this->dataHelper->isSubscribedByDefault(),
            ...
            'deliveryTimeOptions'     => [
                ...
                'houseSecurityCode'  => $this->dataHelper->isDisabledHouseSecurityCode()
            ],
            ...
            'compatible'              => [
                'isEnableModulePostNL' => $this->dataHelper->isEnableModulePostNL(),
            ],
    ...
    {
        return $this->moduleManager->isOutputEnabled('Magepow_SocialLogin') && !$this->dataHelper->isDisabledSocialLoginOnCheckout();
    }
}
